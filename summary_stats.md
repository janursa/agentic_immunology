...
IL-10 (vs PBS) differential TF activity from the ParseBioscience ex-vivo cytokine stimulation study across 5 major immune cell types.

Cytokine names (`condition` / `comparison`): `IL-10`.
