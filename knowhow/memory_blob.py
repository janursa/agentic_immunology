#!/usr/bin/env python3
"""Structured feedback store: knowhow/memory_blob.jsonl.
...
add-tag  -> extend the fixed issue-tag taxonomy in knowhow/issue_tags.json.
"""
import argparse
import datetime
import json
...
KNOWHOW = Path(__file__).parent
TAGS_FILE = KNOWHOW / "issue_tags.json"
BLOB_FILE = KNOWHOW / "memory_blob.jsonl"
LIST_FILE = KNOWHOW.parent / "agents" / "list.md"
