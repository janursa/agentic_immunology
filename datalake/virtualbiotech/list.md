...
All files located in `datalake/virtualbiotech/`. All four files are publicly available from the paper's GitHub repo (`harrisongzhang/TheVirtualBiotech`, `trials_analysis/data/`). Source: Zhang et al. 2026, "The Virtual Biotech" (bioRxiv 2026.02.23.707551).
