...
All files located in `${CIIM_DATALAKE_DIR}/dice/`. Downloaded from the DICE (Database of Immune Cell Expression, eQTLs, and Epigenomics) database at https://dice-database.org.
