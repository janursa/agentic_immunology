...
Run with:
    bash /vol/projects/BIIM/agentic_immunology/tests/test_grn_inference.sh
"""
...
TF_LIST_PATH  = '/vol/projects/BIIM/agentic_immunology/data_lake/ciim/tf_all.csv'
OUTPUT_DIR    = '/vol/projects/BIIM/agentic_immunology/temp/test_grn_output'
...
def test_consistency_with_hiara():
    ...
    tf_all = set(np.loadtxt(
        '/vol/projects/BIIM/agentic_immunology/data_lake/ciim/tf_all.csv',
        dtype=str))
