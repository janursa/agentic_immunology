...
Three files summarising target-level biology and clinical trial outcomes, derived from the Virtual Biotech paper (Zhang et al. 2026) public data. Generated by `${CIIM_MAIN_DIR}/scripts/virtualbiotech_replication/run_analysis.py`.
