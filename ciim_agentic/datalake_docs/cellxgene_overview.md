...
## Perturbations
No dedicated perturbation atlas in the Census (no drug/cytokine conditions flagged in the `disease` field). For perturbations use the HiRA op/parse datasets in `${CIIM_DATALAKE_DIR}/omics/`.
