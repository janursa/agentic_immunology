...
### IBD Pseudobulk RNA — `${CIIM_DATALAKE_DIR}/omics/IBD/rna_bulk.h5ad`
...
- Script: `${CIIM_TEMP_DIR}/ibd_pseudobulk/script.py`

---

## 2026-05-23

### IBD  Multiome — `${CIIM_DATALAKE_DIR}/omics/IBD/`
...
- SLE prior drug targets retrieved from OpenTargets Platform (141 drugs, 129 targets, all phases + approved) → `${CIIM_DATALAKE_DIR}/prior/sle_targets/`; analysis in `analysis/sle_previous_targets/`
...
### eQTL datasets added — `${CIIM_DATALAKE_DIR}/eQTL/`
...
## VirtualBiotech
### Data Downloaded
All 4 files from the public GitHub repo into `${CIIM_DATALAKE_DIR}/virtualbiotech/`:
...
#### NicheNet 
All files under `${CIIM_DATALAKE_DIR}/nichenet/`
...
Downloaded from Zenodo record 10515792 into `${CIIM_DATALAKE_DIR}/gwas/ldsc_grch38/`:
...
New singularity image: `${CIIM_SINGULARITY_DIR}/ldsc.sif` — ciim + pip install ldsc. Provides `ldsc.py`, `munge_sumstats.py`, `make_annot.py`.

### S-LDSC analysis (SLE cell-type specificity)
Workspace: `${CIIM_TEMP_DIR}/sle_ct_specificity/`
