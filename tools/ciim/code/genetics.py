...
run_coloc(gene, chr, pos, outdir, **kwargs)
    ...
    Wraps tools/ciim/code/coloc.R via singularity/genotype.sif.
...
run_mr(gene, mode, outdir, **kwargs)
    ...
    Wraps tools/ciim/code/mr.R via singularity/genotype.sif.
"""
...
def run_coloc(gene, chr, pos, outdir, **kwargs):
    ...
    Wraps temp/coloc/coloc.R executed inside singularity/genotype.sif (R 4.5,
